...
- [resource-fallback](https://github.com/ben-lau/resource-fallback) - Runtime retry, multi-CDN fallback, and origin recovery for Vite build assets (JS/CSS chunks, dynamic import) — zero business code changes.
